...
function showPortfolioItems(category) {
  ...
  items.forEach((item) => {
    ...
    itemElement.className = "image-container relative overflow-hidden rounded-lg cursor-pointer group bg-gray-100";
    itemElement.innerHTML = `
      ...
      <div class="hover-title absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black via-black/70 to-transparent p-4">
